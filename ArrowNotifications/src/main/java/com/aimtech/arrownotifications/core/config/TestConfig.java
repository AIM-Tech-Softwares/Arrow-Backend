...
import com.aimtech.arrownotifications.infrastructure.usecases.MockPasswordRecoveryNotificationServiceImpl;
...
public class TestConfig {
    ...
    public PasswordRecoveryNotificationService passwordRecoveryNotificationService() {
        return new MockPasswordRecoveryNotificationServiceImpl();
    }
}
